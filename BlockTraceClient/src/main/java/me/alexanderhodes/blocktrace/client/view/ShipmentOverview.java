...
public class ShipmentOverview {
	...
	public void initialize() {
		...
		lblUpside.setFont(new Font("Arial", Font.PLAIN, zoom * 16));
		...
		// Add Mouse Listener to Table that by clicking tracking data for
		// shipment is shown
	 ...
	 *
	 * @param model
	 *            Table-Model representing current table
